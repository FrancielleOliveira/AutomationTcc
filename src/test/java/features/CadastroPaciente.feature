...
Feature: Pacientes
  ...
  Scenario: salvar paciente sem inserir CPF
    ...
    And eu selecionar uma opcao para dependentes
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "CPF é obrigatório." em forma de alert no topo da pagina
  ...
  Scenario: salvar paciente sem inserir logradouro
    ...
    And eu selecionar uma opcao para dependentes
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "Logradouro é obrigatório." em forma de alert no topo da pagina
  ...
  Scenario: salvar paciente sem inserir numero
    ...
    And eu selecionar uma opcao para dependentes
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "Numero é obrigatório." em forma de alert no topo da pagina
  ...
  Scenario: salvar paciente sem inserir cep
    ...
    And eu selecionar uma opcao para dependentes
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "CEP é obrigatório." em forma de alert no topo da pagina
  ...
  Scenario: salvar paciente sem inserir cidadeUF
    ...
    And eu selecionar uma opcao para dependentes
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "Cidade/UF é obrigatório." em forma de alert no topo da pagina
