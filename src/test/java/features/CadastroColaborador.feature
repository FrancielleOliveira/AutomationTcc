...
Feature: colaboradores
  ...
  Scenario: salvar  com sucesso
    And eu digitar as informacoes do colaborador completas
  ...
  Scenario: salvar colaborador sem inserir rg
    ...
    And eu escolher a atividade exercida
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "RG é obrigatório." em forma de alert no topo da pagina
  ...
  Scenario: salvar colaborador sem escolher uma atividade exercida
    And eu digitar as informacoes do colaborador completas
      ...
      | fran | 11122233307 |  16234567|     01081991   |  32324455 |
    And eu clicar no botao Salvar
    Then eu devo visualizar a mensagem "Atividade Exercida é obrigatório." em forma de alert no topo da pagina
